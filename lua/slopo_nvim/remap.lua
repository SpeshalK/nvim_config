...
-- Greek letters
vim.keymap.set("i", "<C-g>a", "α")
vim.keymap.set("i", "<C-g>A", "A")
vim.keymap.set("i", "<C-g>b", "β")
vim.keymap.set("i", "<C-g>B", "B")
...
vim.keymap.set("i", "<C-g>r", "ρ")
vim.keymap.set("i", "<C-g>R", "R")
vim.keymap.set("i", "<C-g>s", "σ")
vim.keymap.set("i", "<C-g>S", "Σ")
vim.keymap.set("i", "<C-g>t", "τ")
vim.keymap.set("i", "<C-g>T", "T")
